      ...
      <div className={`  flex w-max flex-col items-start p-0 md:pr-4 ${loc.startsWith("/post/") ? "md:flex" : ""}`}>
        ...
        <div className="flex flex-col space-y-3 py-4 pt-[14px] md:mt-7 md:space-y-[8px] md:bg-neutral-100 md:px-4 md:pt-[4px]">
          ...
          <Link href={(loc.includes('quickie') || loc.includes("hashtag"))?"/quickiemaker":"/create"} className="pt-5">
            <div className="mx-auto flex rounded-full md:rounded-full h-[52px]  w-[52px] cursor-pointer  flex-row content-center items-center bg-blue-700 p-3 transition-all duration-100 ease-linear hover:bg-blue-600 md:mr-auto md:h-[44px] md:w-[calc(180px)] md:py-[14px]">
