...
export default function Search(props){
    ...
    return(<div className="relative items-center content-center">
...
<input onKeyDown={(e) => {
        ...
        }} onChange={(e:any)=>setValue(e.target.value)} minLength={4} maxLength={50} type="search" className="w-full h-12 pr-8 text-[14px] bg-white border border-gray-150 peer focus:outline-black focus:bg-white placeholder:text-neutral-600 font-poppins pl-14" placeholder={"Search "+props.text}></input>
</div>
    )
}