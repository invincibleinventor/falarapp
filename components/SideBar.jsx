export default function NavBar(){
    ...
    <input className="w-full bg-gray-100 rounded-full h-12 focus:outline-black focus:bg-white placeholder:text-neutral-600 font-poppins pl-14 text-[14px]" placeholder="Search Evolt"></input>
    </div>
</div>)
}