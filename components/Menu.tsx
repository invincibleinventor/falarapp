  ...
  return (
    <div className="ml-auto">
      <div
        ...
        className={`${props.type=="comment"?'fixed':'absolute'} py-4 flex my-auto flex-col content-center top-[50%] bottom-[50%] left-0 right-0 w-64 h-28 mx-auto my-auto bg-black/80 backdrop-blur-lg rounded-xl animate-in  shadow-md  md:w-84 lg:w-96 ${deleteDialog ? "" : "hidden"}`}
      >
      ...
      <div className="relative pl-3 ml-auto text-neutral-300">
        ...
        <div
          className={`absolute w-40 bg-black bg-opacity-80 backdrop-blur-lg   shadow-md rounded-xl -left-[calc(34*4px)] top-8 flex flex-col ${dialogopened ? "" : "hidden"}`}
        >
