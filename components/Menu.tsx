...
export default function Menu(props:any){
    ...
    return(
     ...
     <div  className={`absolute w-40 bg-[#090909]  rounded-xl shadow-sm border border-gray-900 shadow-gray-900 -left-[calc(34*4px)] top-8 flex flex-col ${dialogopened?'':'hidden'}`}>
