...
export default function App (props:pros) {
   ...
   let a = {'opened': false}
    ...
    return(
        <Link href={props.link} className={`flex flex-row rounded-full px-3 md:px-[6px] md:pr-8 w-max md:w-full py-[10px] mx-2 md:mx-0 md:space-x-[16px] rounded-lg transition-all ease-linear duration-100 cursor-pointer items-center content-center  ${a.opened?'':''}`}>
