...
.subscribe()
  ...
  return (
    <div className="relative">
        {notifications>0 &&
                <div className="absolute top-0 font-medium left-1 flex items-center content-center px-2 py-1 text-[10px] text-white rounded-full min-w-6 bg-cyan-700 aspect-video"><h1 className="mx-auto">{notifications}</h1></div>
        }
    <Link
      href={props.link}
