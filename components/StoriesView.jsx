...
export default function StoriesView(props){
	...
	return (
        <div className='flex flex-row px-0 pt-0 shadow-lg'>
        <div onClick={()=>setVisible(!visible)} style={{background: `url('${props.image}')`}} className='relative w-24 h-32 rounded-md bg-gradient-to-b from-black to-neutral-400'>
