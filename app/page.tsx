...
get()},[])
  ...
  <div className="p-4 py-2 pb-4 mx-1 md:mx-2 bg-opacity-50 ">
    ...
    <input className="w-full border border-gray-100 bg-red-50 peer bg-opacity-10 rounded-lg h-12 focus:outline-red-400 focus:bg-white placeholder:text-neutral-600 font-poppins pl-14 pr-8 text-[14px]" placeholder="Search Evolt"></input>
    </div>
</div>
