...
export default function StoryView() {
  ...
  return (
    <div className="absolute z-[100000] bg-black h-screen lg:h-max lg:w-max lg:mx-auto w-screen left-0 right-0 bottom-0 top-0 flex flex-col items-center justify-center lg:static">
      <div className="absolute flex items-center content-center justify-between text-white lg:hidden top-5 left-5">
        <h1 className="text-2xl font-semibold text-white">Story</h1>
      </div>
      <Stories
