...
get()},[])
  ...
  <div className="p-4 py-2 pb-4 mx-1 bg-opacity-50 md:mx-1 ">
    ...
    <input className="w-full border border-gray-200 bg-white peer rounded-lg h-12 focus:outline-black focus:bg-white placeholder:text-neutral-600 font-poppins pl-14 pr-8 text-[14px]" placeholder={"Search "+params.slug+"'s"+" posts"}></input>
    </div>
</div>
